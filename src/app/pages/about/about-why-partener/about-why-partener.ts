...
@Component({
  selector: 'app-about-why-partener',
  standalone: true,
  templateUrl: './about-why-partener.html',
  styleUrl: './about-why-partener.scss',
})
export class AboutWhyPartener implements AfterViewInit, OnDestroy {
